...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  //=== VK_VERSION_1_0 ===
  template <>
  struct StructExtends<ShaderModuleLoadInfo, PipelineShaderStageCreateInfo>
  {
    enum
    {
      value = true
...
#  endif /*VK_ENABLE_BETA_EXTENSIONS*/
  ...
  //=== VK_EXT_validation_cache ===
  template <>
  struct StructExtends<ShaderModuleValidationCacheCreateInfoEXT, ShaderModuleLoadInfo>
  {
    enum
    {
      value = true
...
#  endif /*VK_USE_PLATFORM_GGP*/
  ...
  template <>
  struct StructExtends<ValidationFeaturesEXT, ShaderModuleLoadInfo>
  {
    enum
    {
      value = true
